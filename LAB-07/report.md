...
При этом объем аудитории $N = 2300$, в начальный момент о товаре знает 20 человек.
...
model Project
  ...
  annotation(experiment(StartTime=0, StopTime=0.3, Tplerance=1e-06,Interval=0.0005));
