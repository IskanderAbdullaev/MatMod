...
В начальный момент времени страна $X$ имеет армию численностью 32500 человек, а в распоряжении страны $Y$ армия численностью в 13800 человек.
...
$$
 \begin{cases}
	...
	\\   
	\frac{dy}{dt}= -0.62x(t)y(t) - 0.13y(t) + |cos(t)|
 \end{cases}
$$
