...
subtitle: "Задача о погоне - вариант 41"
...
Через определенный промежуток времени туман рассеивается, и лодка обнаруживается на расстоянии 17.4 км от катера. 
...
n=4.8 #разница в скорости
s=17.4 #расстояние обнаружения
