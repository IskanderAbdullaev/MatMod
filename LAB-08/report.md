...
$$\frac{dM_1}{d\Theta} = M_1 - (\frac{b}{c_1} + 0.00021)M_1 M_2 - \frac{a1}{c1} M_1^2 $$
...
$$ p_{cr}=35 \: N=41 \: q=1 $$
$$ \tau_1=14 \: \tau_2=7 $$
$$ \widetilde{p}_1=6.5 \: \widetilde{p}_2=15 $$
...
model Project
  ...
  parameter  Real tau2 = 7;

  parameter  Real p1 = 6.5;
  parameter  Real p2 = 15;

  parameter  Real d = 0.00021;
